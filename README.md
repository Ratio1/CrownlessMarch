...
```bash
pnpm live:devnet -- --expect-version=1.14.7
pnpm live:browser -- --expect-version=1.14.7
pnpm live:browser -- --expect-version=1.14.7 --profile=all --combat --reset --reconnect-probe-ms=15000 --idle-ms=300000 --report-path=test-results/live/browser-smoke-report.json
```
...
pnpm regression:live -- --expect-version=1.14.7
