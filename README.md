...
```bash
pnpm live:devnet -- --expect-version=1.9.5
pnpm live:browser -- --expect-version=1.9.5
pnpm live:browser -- --expect-version=1.9.5 --profile=all --report-path=test-results/live/browser-smoke-report.json
```
...
pnpm regression:live -- --expect-version=1.9.5
